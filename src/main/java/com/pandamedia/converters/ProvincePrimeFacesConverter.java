 ...
 */
@RequestScoped
@Named("provincePFConverter")
public class ProvincePrimeFacesConverter  implements Converter {
    
    @Inject
    private ProvinceJpaController service;
 
    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
        if(value != null && value.trim().length() > 0) {
            try {   
                return service.findProvince(Integer.parseInt(value));              
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object object) {
        if(object != null) {
            return String.valueOf(((Province) object).getId());
        }
        else {
            return null;
        }
